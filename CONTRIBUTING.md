...
Start with the [glossary](CONTEXT.md) and [current architecture](docs/architecture.md),
then use this guide to set up a checkout and complete one ticket. The
[documentation index](docs/README.md) groups the other guides by task. This route
...
an empty scaffold. Use [new course setup](docs/solid/new-course-setup.md) for input
...
The backlog remains in `.scratch/reliable-exam-analysis/issues/`; the
[status table](.scratch/reliable-exam-analysis/TICKET_STATUS.md) is generated from
...
current evidence. The [ticket workflow](docs/ticket-workflow.md) explains other
...
[branch consolidation record](docs/research/branch-consolidation-2026-09-17.md)
...
[Git and pull request research](docs/research/git-and-pull-requests-for-ai-development.md)
...
[model request limits guide](pipeline/docs/model-request-limits.md). After approval,
follow [new course setup](docs/solid/new-course-setup.md) to save a candidate.
