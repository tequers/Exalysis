...
`.scratch/reliable-exam-analysis/issues/`. Its folder is its workflow state.
...
Start from `.scratch/reliable-exam-analysis/TEMPLATE.md`. Keep the H1 title and
...
`CONTEXT.md`, approved decisions in `docs/adr/`, and applicable versioned contracts
