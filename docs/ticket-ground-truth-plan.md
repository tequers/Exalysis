...
This is an implementation plan. It does not change ticket status, approve completed work, or implement the tooling.
...
and the [generated backlog](../.scratch/reliable-exam-analysis/TICKET_STATUS.md)
shows the migrated records. The [migration report](../.scratch/reliable-exam-analysis/MIGRATION_REPORT.md)
