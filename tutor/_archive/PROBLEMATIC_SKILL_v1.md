# Problematic — Problem-First Framing (v1, course-agnostic)
...
Then **stop.** No mechanism, no rung question, no offer to explain further.
...
- Does it end on the bridge line and stop?
